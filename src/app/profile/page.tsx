                ...
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex flex-col items-center">
                        ...
                        */}
                            ...
                            <a href="#" className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Resume</a>
                            </div>


                        <dt className="text-gray-700 uppercase font-bold tracking-wider mt-2     ">
                    Email address
                </dt>
                <dd className="mb-1">
                    johndoe@example.com
                </dd>   
                <dt className="text-gray-700 uppercase font-bold tracking-wider ">
                    Phone Number
                </dt>
                <dd className="mb-2">
                    0912312810
